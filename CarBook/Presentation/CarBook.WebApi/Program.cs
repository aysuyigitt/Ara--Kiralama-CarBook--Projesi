...
using CarBook.Persistence.Repositories.StatisticsRepository;
...
builder.Services.AddScoped(typeof(ICarPricingRepository), typeof(CarPricngRepository));
...
builder.Services.AddScoped(typeof(IStatisticsRepository), typeof(StatisticsRepsoitory));


builder.Services.AddScoped<GetAboutQueryHandler>(); 
builder.Services.AddScoped<GetAboutByýdQueryHandler>(); 
