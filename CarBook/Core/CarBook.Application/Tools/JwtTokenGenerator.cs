...
namespace CarBook.Application.Tools
{
	...
	{
		public static TokenResponseDto GenerateToken(GetCheckAppUserQueryRseult result)
		{
		...
		public static object? GenerateToken(Task<GetCheckAppUserQueryRseult> values)
		{
